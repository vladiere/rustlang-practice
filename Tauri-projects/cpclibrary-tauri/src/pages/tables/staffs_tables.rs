...
#[component]
pub fn StaffsTables() -> impl IntoView {
    ...
    view! {
       <Box class="bg-transparent flex flex-col gap-10">
           <Box class="grid grid-cols-2 gap-5">
               <H1 class="font-semibold">"Staff table list"</H1>
                <div class="relative">
                ...
                <Box class="bg-transparent flex justify-left">
                   <Button on_click=move |_| {} color=ButtonColor::Primary >"Register new staff"</Button>
               </Box>
           </Box>
            <TableContainer>
