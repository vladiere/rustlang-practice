...
#[component]
pub fn PendingTables() -> impl IntoView {
    ...
    view! {
       <Box class="bg-transparent flex flex-col gap-10">
           <Box class="grid grid-cols-2 gap-5">
               <H1 class="font-semibold">"Pending list"</H1>
                <div class="relative">
            ...
            <TableContainer>
                <Table bordered=true hoverable=true class="table-auto">
                    <TableHeader>
                        <TableRow>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>
                                        <Button variant=ButtonVariant::Flat on_click=move |_| {}>
                                            <Icon icon=icondata::BiCheckDoubleRegular style="font-size: 18px; color: #22c55e;" />
                                        </Button>
                                    </TableCell>
                                    <TableCell>
                                        <Button variant=ButtonVariant::Flat on_click=move |_| {}>
                                            <Icon icon=icondata::ChCross style="font-size: 18px; color: #ef4444;" />
                                        </Button>
                                    </TableCell>
                                </TableRow>
                            }
